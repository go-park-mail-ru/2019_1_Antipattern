...
func easyjson6a93d021DecodeTest(in *jlexer.Lexer, out *UserDataPayload) {
...
func easyjson6a93d021EncodeTest(out *jwriter.Writer, in UserDataPayload) {
	out.RawByte('{')
	first := true
	_ = first
	if in.Login != "" {
...
func easyjson6a93d021DecodeTest1(in *jlexer.Lexer, out *Response) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson6a93d021EncodeTest1(out *jwriter.Writer, in Response) {
	out.RawByte('{')
	first := true
	_ = first
	{
...
func easyjson6a93d021DecodeTest2(in *jlexer.Lexer, out *Request) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson6a93d021EncodeTest2(out *jwriter.Writer, in Request) {
	out.RawByte('{')
	first := true
	_ = first
	{
...
func easyjson6a93d021DecodeTest3(in *jlexer.Lexer, out *ErrorPayload) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson6a93d021EncodeTest3(out *jwriter.Writer, in ErrorPayload) {
	out.RawByte('{')
	first := true
	_ = first
	if in.Message != "" {
